...
def get_params():
    ...
    parser.add_argument('--alpha', dest='alpha', type=float, default=10.0, help='weight on regression loss')
    parser.add_argument('--beta', dest='beta', type=int, default=1, help='weight on kl div loss')
    parser.add_argument('--latent_dims', dest='latent_dims', type=int, default=32, help='latent space dimension')
